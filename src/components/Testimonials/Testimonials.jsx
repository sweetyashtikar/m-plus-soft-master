        ...
        <div className='container'>
            <div className='testimonials-content'>
                <div className='section-t text-center'>
                    <p className='text'>  As a Customer First organisation, we provide cost-effective software development services that are user-friendly and designed to bring life to our client’s visions.</p>
                </div>
